...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.nicolaivalenta.valvoice.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("com.nicolaivalenta.valvoice.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("ValVoiceMainWindowFrame")

    private let logger = Logger(subsystem: "com.nicolaivalenta.valvoice", category: "WindowManager")
    ...
    func configureOnboardingPanel(_ window: NSWindow) {
        ...
        window.title = "ValVoice Onboarding"
