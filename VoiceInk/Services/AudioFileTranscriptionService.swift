...
class AudioTranscriptionService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.nicolaivalenta.valvoice", category: "AudioTranscriptionService")
    ...
    init(modelContext: ModelContext, engine: ValVoiceEngine) {
