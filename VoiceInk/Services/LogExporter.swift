...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.nicolaivalenta.valvoice", category: "LogExporter")
    private let subsystem = "com.nicolaivalenta.valvoice"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== ValVoice Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "ValVoice_Logs_\(timestamp).log"
